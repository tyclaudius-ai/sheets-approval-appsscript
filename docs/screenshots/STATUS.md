...
- **custom**: canonical PNG differs from both placeholder + real-ish

| id | file | status | notes |
|---:|---|---|---|
| `01-menu` | `01-menu.png` | **real-ish** | 1) Menu (Approvals) |
| `02-requests-pending` | `02-requests-pending.png` | **real-ish** | 2) Requests sheet (pending) |
| `03-approved-row` | `03-approved-row.png` | **real-ish** | 3) Approved row |
